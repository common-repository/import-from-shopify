...
class CDShopifyPluginSettings
{
    private $plugin_slug;
    private $version;

    function __construct() {
        $this->plugin_slug = 'import-from-shopify';
        $this->version = '1.0.1';
    ...
    public function enqueue_styles( $hook ) {
        wp_enqueue_style( 'admin-import_shopify', plugin_dir_url( __FILE__ ) . '../assets/css/import_shopify.css', array(), $this->version, 'all' );
    }
    ...
    function  import_from_shopify_page_content() {
        ?>
        <h1><?php _e('Import from Shopify', $this->plugin_slug) ?></h1>
        <?php
